...
function Action() {
    return (
        <div className="flex items-center gap-[32px]">
            {/* Play button */}
            <a className="text-[26px] w-[70px] h-[70px] rounded-full flex items-center justify-center opacity-95 hover:shadow-[0_5px_10px_10px_#ffda7d26] bg-gradient-to-br from-yellow-400 to-yellow-100 cursor-pointer">
